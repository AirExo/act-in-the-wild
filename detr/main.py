...
def get_args_parser():
    ...
    parser.add_argument('--freq', action='store', type=float, help='frequency', required=False)
    parser.add_argument('--kl_weight', action='store', type=int, help='KL Weight', required=False)
    parser.add_argument('--chunk_size', action='store', type=int, help='chunk_size', required=False)
    parser.add_argument('--temporal_agg', action='store_true', required=False)
    parser.add_argument('--robot_cfgs', action='store', type=str, help='real-robot evaluation config file', required=False)
